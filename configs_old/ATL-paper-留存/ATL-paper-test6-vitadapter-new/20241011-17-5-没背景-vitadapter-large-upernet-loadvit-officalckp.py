...
L1_num_classes = 5  # number of L1 Level label
L2_num_classes = 11  # number of L1 Level label
L3_num_classes = 21 # number of L1 Level label reduce_zerp_label
...
crop_size = (512, 512)
pretrained = '/share/home/aitlong/AI-Tianlong/checkpoints/0-atl-自己预训练的/mmpretrainformat-10chan-ViT-Adapter-Aug-L-BGR.pth'
# pretrained = None
