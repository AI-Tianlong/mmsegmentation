...
with read_base():
    from .._base_.datasets.atl_0_paper_TUM_class13 import *
...
num_classes = 13  # loss 要用，也要加 # 加上背景是25类
...
model.update(
    dict(
        ...
        test_cfg=dict(mode='slide', crop_size=crop_size, stride=(76, 76))))
...
load_from = None
# load_from = '/opt/AI-Tianlong/checkpoints/atl_s2_农作物分类可用的权重/24类地物-BEIT-Adapter-24类地物覆盖-GID150张s2训练/3-s2-5b-24类地物-黑龙江省伪标签-80000iter-81.49mIoU.pth'
