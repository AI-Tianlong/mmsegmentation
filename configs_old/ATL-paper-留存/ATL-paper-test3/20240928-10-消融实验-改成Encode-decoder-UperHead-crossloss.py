...
# num_classes = 22
num_classes = L1_num_classes + L2_num_classes + L3_num_classes  # 这个不怎么用到? # 40 了
...
model.update(
    dict(
        ...
        decode_head=dict(
            ...
            dropout_ratio=0.1,
            out_channels = L3_num_classes, #是输出的通道数，这里是40，和num_classes对应
            num_classes=L3_num_classes, #22，和con_seg，和out_channels对应。在basedecodehead里 这里要设置成40，否则slide推理的时候都会有问题。
