...
crop_size = (512, 512)
pretrained = '/opt/AI-Tianlong/0-ATL-paper-work/0-预训练好的权重/mmseg-vit/mmseg-vit-base-ade20k.pth'
# pretrained = None
...
model.update(
    dict(
        ...
        backbone=dict(
            ...
            norm_eval=False,
            interpolate_mode='bicubic'), # mmseg的原版vit
        ...
        decode_head=dict(
            ...
            in_index=[0, 1, 2, 3],
            pool_scales=(1, 2, 3, 6),
            channels=512,   # 这是个 啥参数来着？ # 512 1024
            dropout_ratio=0.1,
