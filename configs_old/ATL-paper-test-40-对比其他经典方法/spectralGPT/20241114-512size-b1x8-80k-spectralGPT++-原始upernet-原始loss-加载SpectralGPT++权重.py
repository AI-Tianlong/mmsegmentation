...
crop_size = (512, 512)
pretrained = '/opt/AI-Tianlong/0-ATL-paper-work/0-预训练好的权重/2-对比实验的权重/spectral-GPT的权重/SpectralGPT+.pth'
...
model.update(
    dict(
        ...
        test_cfg=dict(mode='slide', crop_size=crop_size, stride=(341, 341))))# 在512的图上推理
...
default_hooks.update(
    dict(logger=dict(type=LoggerHook, interval=100, log_metric_by_epoch=False)))
