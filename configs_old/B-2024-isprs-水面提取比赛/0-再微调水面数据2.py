...
train_cfg.update(
    dict(type=IterBasedTrainLoop, max_iters=80000, val_interval=400))
...
load_from = '/opt/AI-Tianlong/openmmlab/mmsegmentation/work_dirs/0-比赛-格外数据2-这个好/iter_80000.pth'
# load_from = None
