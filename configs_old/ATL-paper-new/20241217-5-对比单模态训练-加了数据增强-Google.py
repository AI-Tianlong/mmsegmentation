...
with read_base():
    from .._base_.datasets.a_atl_0_paper_5b_Google_19class import *
...
crop_size = (512, 512)
pretrained = '/opt/AI-Tianlong/0-ATL-paper-work/0-预训练好的权重/2-对比实验的权重/vit-adapter/mmpretrainformat-3chan-ViT-Adapter-Aug-L.pth'
