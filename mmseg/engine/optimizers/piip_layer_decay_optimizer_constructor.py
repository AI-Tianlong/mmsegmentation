...
class CustomLayerDecayOptimizerConstructor(DefaultOptimWrapperConstructor):
    def add_params(self, params, module, prefix='', is_dcn_module=None):
        ...
        print_log("Build LayerDecayOptimizerConstructor %f - %d" % (layer_decay_rate, num_layers))
...
@OPTIM_WRAPPER_CONSTRUCTORS.register_module()
class CustomLayerDecayOptimizerConstructorInternImage(DefaultOptimWrapperConstructor):
    ...
    def add_params(self, params, module, prefix='', is_dcn_module=None):
        ...
        print_log("Build CustomLayerDecayOptimizerConstructorInternImage %f - %d" %
