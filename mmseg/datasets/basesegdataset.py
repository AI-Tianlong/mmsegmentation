...
class Base_Multimodal_Google_GF2_S2_Dataset(BaseDataset):
    ...
    .. code-block:: none
        ...
        │   │   │   ├── train
        │   │   │   │   ├── Google
        |   │   │   │   │   ├── Google_GF2_xxx{img_suffix}
        |   │   │   │   │   ├── Google_GF2_yyy{img_suffix}
        |   │   │   │   │   ├── Google_GF2_zzz{img_suffix}
        │   │   │   │   ├── GF2
        |   │   │   │   │   ├── GF2_xxx{img_suffix}
        |   │   │   │   │   ├── GF2_yyy{img_suffix}
        |   │   │   │   │   ├── GF2_zzz{img_suffix}
        │   │   │   │   ├── S2
        |   │   │   │   │   ├── S2_GF2_xxx{img_suffix}
        |   │   │   │   │   ├── S2_GF2_yyy{img_suffix}
        |   │   │   │   │   ├── S2_GF2_zzz{img_suffix}
        │   │   │   ├── val
        │   │   ├── ann_dir
        │   │   │   ├── train
        │   │   │   │   ├── Google
        |   │   │   │   │   ├── Google_GF2_xxx{seg_map_suffix}
        |   │   │   │   │   ├── Google_GF2_yyy{seg_map_suffix}
        |   │   │   │   │   ├── Google_GF2_zzz{seg_map_suffix}
        │   │   │   │   ├── GF2
        |   │   │   │   │   ├── GF2_xxx{seg_map_suffix}
        |   │   │   │   │   ├── GF2_yyy{seg_map_suffix}
        |   │   │   │   │   ├── GF2_zzz{seg_map_suffix}
        │   │   │   │   ├── S2
        |   │   │   │   │   ├── S2_GF2_xxx{seg_map_suffix}
        |   │   │   │   │   ├── S2_GF2_yyy{seg_map_suffix}
        |   │   │   │   │   ├── S2_GF2_zzz{seg_map_suffix}
        │   │   │   ├── val

    【ATL-LOG】The image names in ``img_path_MSI_3chan`` and ``img_path_MSI_4chan`` and
    ``img_path_MSI_10chan``should be consistent.
    ...
    Args:
        ...
        img_suffix_MSI_3chan(str): Suffix of images. Default: '.tif'
        img_suffix_MSI_4chan(str): Suffix of images. Default: '.tif'
        img_suffix_MSI_10chan(str): Suffix of images. Default: '.tif'
        seg_map_suffix_MSI_3chan (str): Suffix of segmentation maps. Default: '.tif'
        seg_map_suffix_MSI_4chan (str): Suffix of segmentation maps. Default: '.tif'
        seg_map_suffix_MSI_10chan (str): Suffix of segmentation maps. Default: '.tif'
        ...
        serialize_data (bool, optional): Whether to hold memory using
            ...
            to True.
        pipeline (list, optional): Processing pipeline. Defaults to [].  # 处理数据的pipline啊
        ...
        ignore_index (int): The label index to be ignored. Default: 255  # 忽略的标签值
        reduce_zero_label (bool): Whether to mark label zero as ignored. # 是否reduce_zero_label
            Default to False.
    ...
    def __init__(self,
                 ...
                 data_prefix: dict = dict(     # 输入三组数据的路径
                     img_path_MSI_3chan='', 
                     img_path_MSI_4chan='', 
                     img_path_MSI_10chan='', 
        ...
        # Join paths.  # 拼接 data_root 和 data_prefix
    ...
    def get_label_map(cls,
        ...
        """
        old_classes = cls.METAINFO.get('classes', None) #数据集类的METAINFO
    ...
    def load_data_list(self) -> List[dict]:
        ...
        if osp.isfile(self.ann_file):
            ...
            # import pdb; pdb.set_trace()
            for img_MSI_4chan_name in fileio.list_dir_or_file(
                    dir_path=img_dir_MSI_4chan,  # GF2_img_path
                    list_dir=False,
                    suffix=self.img_suffix_MSI_4chan,
                    recursive=True,
                    backend_args=self.backend_args):
                
                if '.' in osp.basename(img_MSI_4chan_name):
                    img_basename, img_ext = osp.splitext(img_MSI_4chan_name)
                    self.img_suffix_MSI_3chan = img_ext
                    self.img_suffix_MSI_4chan = img_ext
                    self.img_suffix_MSI_10chan = img_ext
                
                # 图像路径添加到 data_info
                data_info = dict(                                   
                    img_path_MSI_3chan=osp.join(img_dir_MSI_3chan, 'Google_'+ img_basename + self.img_suffix_MSI_3chan),
                    img_path_MSI_4chan=osp.join(img_dir_MSI_4chan,  img_basename + self.img_suffix_MSI_4chan),
                    img_path_MSI_10chan=osp.join(img_dir_MSI_10chan, 'S2_'+ img_basename + self.img_suffix_MSI_10chan))

                if ann_dir_MSI_3chan and ann_dir_MSI_4chan and ann_dir_MSI_10chan is not None:
                    seg_map_MSI_3chan = 'Google_'+ img_basename + self.seg_map_suffix_MSI_3chan
                    seg_map_MSI_4chan = img_basename + self.seg_map_suffix_MSI_4chan
                    seg_map_MSI_10chan = 'S2_'+ img_basename + self.seg_map_suffix_MSI_10chan
                ...
                data_info['seg_fields'] = []
                data_list.append(data_info)
            data_list = sorted(data_list, key=lambda x: x['img_path_MSI_4chan'])
        return data_list


@DATASETS.register_module()
class Base_3embedding_Dataset(BaseDataset):
    """Custom dataset for change detection. An example of file structure is as
    followed.
    ...
    Args:
        ...
        img_suffix_RGB_3chan(str): Suffix of images. Default: '.jpg'
        img_suffix_MSI_4chan(str): Suffix of images. Default: '.jpg'
        img_suffix_MSI_10chan(str): Suffix of images. Default: '.jpg'
        seg_map_suffix_RGB_3chan (str): Suffix of segmentation maps. Default: '.png'
        seg_map_suffix_MSI_4chan (str): Suffix of segmentation maps. Default: '.png'
        seg_map_suffix_MSI_10chan (str): Suffix of segmentation maps. Default: '.png'
    ...
    def load_data_list(self) -> List[dict]:
        ...
        if not osp.isdir(self.ann_file) and self.ann_file:
            ...
            for img in fileio.list_dir_or_file(
                    ...
                    recursive=True,
                    backend_args=self.backend_args): #顺序是固定的,每次都是这个啊
                # img：'train/GF2_PMS2__L1A0000647892-MSS2_5_12.tif'
                # {'img_path': 'data/1-paper-segmentation/2-多领域地物覆盖基础/0-seg-裁切好的训练图像_S2_GF2_Google_size512/img_dir/train/GF2_5B_19类_size512/train/GF2_PMS2__L1A0000647892-MSS2_5_12.tif', 'seg_map_path': 'data/1-paper-segmentation/2-多领域地物覆盖基础/0-seg-裁切好的训练图像_S2_GF2_Google_size512/ann_dir/train/GF2_5B_19类_size512/train/GF2_PMS2__L1A0000647892-MSS2_5_12.tif', 'label_map': None}
                data_info = dict(img_path=osp.join(img_dir, img))
                if ann_dir is not None:
                    # seg_map'train/GF2_PMS2__L1A0000647892-MSS2_5_12.tif'
                    seg_map = img[:-_suffix_len] + self.seg_map_suffix # 图像名字+label后缀
                    data_info['seg_map_path'] = osp.join(ann_dir, seg_map)
                data_info['label_map'] = self.label_map # None
                data_info['reduce_zero_label'] = self.reduce_zero_label
                data_info['seg_fields'] = []
                data_list.append(data_info)  # 加入这个img到data_list
