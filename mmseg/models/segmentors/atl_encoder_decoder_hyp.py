...
class EncoderDecoder_hyp(BaseSegmentor):
    ...
    def __init__(self,
        ...
        offsets_ = torch.zeros(num_classes, self.dim)  # 19个类别，每个类别对应一个offset
    ...
    def init_embedding_space(self):
        return self.decode_head.init_embedding_space()
