...
class ConvNextHFWrapper(nn.Module):
    def __init__(self, 
        ...
        self.embed_dim = self.convnext_model.config.hidden_sizes[-1] # 1024
        ...
        if with_simple_fpn:  # False
            ...
            if not single_branch:
                self.downsample_ratios = downsample_ratios # [4, 4, 4, 8, 8, 8, 8, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 32, 32, 32, 32]
