...
class TransLU_backbone_CDKS(BaseModule):
    def __init__(self,
                branch1_backbone={},
                branch2_backbone={},
        ...
        if isinstance(self.branch1_backbone, ConvNeXt): # mmseg的自建convnext，不是从mmpretrain导入的！
            dims1 = self.branch1_backbone.out_dims #    专门写的这个属性
    ...
    def forward(self, x):
        ...
        x_origin = x.clone() # [4,10,512,512]
        branch2_output_list = self.branch2_backbone(x_origin) # [4,10,512,512]-->[1,128,128,128] [1,256,64,64] [1,512,32,32] [1,1024,16,16]
        ...
        branch1_output_list = [f1, f2, f3, f4] # [1,128,128,128] [1,256,64,64] [1,512,32,32] [1,1024,16,16]
