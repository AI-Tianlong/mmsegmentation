...
class ATL_Hiera_LightHamHead_Multi_convseg_baseline(BaseDecodeHead):
    """SegNeXt decode head.
    ...
    def __init__(self, ham_channels=512, ham_kwargs=dict(), **kwargs):
        ...
        self.ham_channels = ham_channels
                ...
                # ====================== Hiera ======================
        self.merge_hiera = True
        
    
        self.num_classes_level_list = [5,9,10]  # [5,9,10]

        self.conv_seg_L1 = nn.Conv2d(self.channels, 5, kernel_size=1) #(1024-->6)
        self.conv_seg_L2 = nn.Conv2d(self.channels, 10, kernel_size=1) #(1024-->12)
