...
class DepthwiseSeparableASPPHead_Hiera(ASPPHead):
    ...
    def __init__(self, 
        ...
        self.proj_head = ProjectionHead(dim_in=self.in_channels,   # backbone的最后一个特征图的维度
                                        norm_cfg=self.norm_cfg, 
                                        proj=proj)
    ...
    def forward(self, inputs):
        ...
        output_list, embedding = self.hiera_module(inputs, output) 
