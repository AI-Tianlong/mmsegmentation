...
class UPerHead_Hiera_2branch(BaseDecodeHead):
    ...
    #     if isinstance(self.init_cfg, dict) and self.init_cfg.get('type') == 'Pretrained_Part':
    ...
    def hiera_module(self, inputs: List[Tensor], decode_head_outputs: Tensor):
        ...
        if self.hiera_mode == 'xiaorong1':
            ...
            avgout_L1 = self.mlp_L1(avgout_L1.view(avgout_L1.size(0),-1)) # [2,4,1,1]-->[2,1024]
