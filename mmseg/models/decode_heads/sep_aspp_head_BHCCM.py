...
class DepthwiseSeparableASPPHead_BHCCM(ASPPHead):
    ...
    def __init__(self, 
        ...
        # ================== 原始 DepthwiseSeparableASPPHead 的结构 =========
    ...
    def forward(self, inputs):
        ...
        output = self.sep_bottleneck(output)  # [4,512,160,160]


        # ================ BHCCM 做的改动 ========================
        # inputs:[2,256,160,160][4,512,80,80][4,1024,80,80][4,2048,80,80]
        # output:[2,512,160,160]-->[2,18,160,160]
        output_list = self.hiera_module(inputs, output)  # [2,4,160,160] [2,9,160,160] [2,18,160,160]
        return output_list

        # output = self.cls_seg(output)  # [4,512,160,160]-->[4,18,160,160]
        # return output
