...
dataset_type = 'mmseg.datasets.potsdam.PotsdamDataset'
default_hooks = dict(
    checkpoint=dict(
...
launcher = 'pytorch'
load_from = 'work_dirs/beit_adapter_mask2former_4xb16_potsdam-512x512/iter_56000.pth'
log_level = 'INFO'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        type='mmseg.datasets.potsdam.PotsdamDataset'),
    num_workers=4,
...
visualizer = dict(
    name='visualizer',
    save_dir='./atl_vis_potsdam2',
    type='mmseg.visualization.SegLocalVisualizer',
    vis_backends=[
        dict(type='mmengine.visualization.LocalVisBackend'),
    ])
work_dir = './work_dirs/beit_adapter_mask2former_4xb16_potsdam-512x512'
