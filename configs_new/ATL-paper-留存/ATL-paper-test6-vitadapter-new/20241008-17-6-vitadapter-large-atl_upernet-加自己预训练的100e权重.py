...
crop_size = (512, 512)
pretrained = '/opt/AI-Tianlong/0-ATL-paper-work/0-预训练好的权重/2-mmpretrain-vit-large-原版mae-epoch_100-onlybackbone.pth'
# pretrained = None
...
model.update(
    dict(
        ...
        decode_head=dict(
            ...
            dropout_ratio=0.1,
            num_classes=num_classes, #40 #用ATL_UperHead的话，这里得改成40
