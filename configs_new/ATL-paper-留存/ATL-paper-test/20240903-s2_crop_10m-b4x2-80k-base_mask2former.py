...
num_classes = 4  # loss 要用，也要加 # 加上背景是25类
...
model.update(
    dict(
        ...
        decode_head=dict(
            feat_channels=256,  # 256 类别多的话：1024
            out_channels=256,  # 256 类别多的话：1024
            num_classes=num_classes,
            num_queries=100,  # 100 200
                ...
                encoder=dict(
                    ...
                    layer_cfg=dict(
                        ...
                        ffn_cfg=dict(
                            ...
                            embed_dims=256,  #256 1024
                            feedforward_channels=2048,  #2048 4096
                            num_fcs=2,
                            ffn_drop=0.0,
                            # with_cp=True,
...
# load_from =
load_from = '/opt/AI-Tianlong/checkpoints/atl_s2_农作物分类可用的权重/3类作物-Beit-adapter-水稻-大豆-玉米-三类-10m-黑龙江省/s2_crop_10m_nochongdie60%_10bands_BGR_beitadapter_mask2former_4xb2_80k_load_beitpr-miout-81.92.pth'
