...
# 训练好的权重：/data/AI-Tianlong/ZGJ/checkpoints/5B-pretrained/BEiT/5-s2-5billion-24类地物-用5的接着训-黑龙江省tain和val都训-iter80k-mIoU82.69.pth
# 训练好的权重：/data/AI-Tianlong/ZGJ/mmsegmentation/work_dirs/ZGJ-S2-BEiTv2-mask2former-18类-512/iter_4000.pth
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            img_path=
            '/data/AI-Tianlong/ZGJ/Datasets/0-S2-IMG-2024年/4-用来多GPU推理的5000图像',
            # seg_map_path=''
        ),
        # ann_file='',
