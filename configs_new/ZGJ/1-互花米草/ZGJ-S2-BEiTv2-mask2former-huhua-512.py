...
# 训练好的权重：/data/AI-Tianlong/ZGJ/mmsegmentation/work_dirs/ZGJ-S2-BEiTv2-mask2former-huhua-512/iter_80000.pth
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            ...
            # '/data/AI-Tianlong/ZGJ/Datasets/0-S2-IMG-2024年/4-用来多GPU推理的5000图像', # 2024
...
default_hooks.update(
    ...
    checkpoint=dict(type=CheckpointHook, by_epoch=False, interval=2000, max_keep_ckpts=40),
