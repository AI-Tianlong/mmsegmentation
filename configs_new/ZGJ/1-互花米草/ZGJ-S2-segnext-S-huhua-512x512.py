...
checkpoint_file = 'checkpoints/5B-pretrained/segnext/S2-segnext-S-5B-pretrained.pth'   # noqa
...
default_hooks.update(
    ...
    checkpoint=dict(type=CheckpointHook, by_epoch=False, interval=2000, max_keep_ckpts=20),
