...
with read_base():
    from ..._base_.datasets.GF2_5B_18class_640_daqi import *
...
pretrained = '/opt/workspace/AI-Tianlong/openmmlab/mmsegmentation/work_dirs/0-20251230-BHCCM/baseline-GF2/part2-baseline-GF2-convnext-L-upernet-baseline-640x640-75.32-83.31/iter_80000.pth'
# 统计一下
data_preprocessor = dict(
        type=SegDataPreProcessor,
        mean = [1821.0616064075334, 1949.1679245433477, 1683.757136676093, 3606.5571867924455],
        std  = [1602.7621801865653, 1649.4428646471004, 1451.4841215772717, 3161.0606108795428],
        pad_val=0,
        seg_pad_val=255,
        size=crop_size)
