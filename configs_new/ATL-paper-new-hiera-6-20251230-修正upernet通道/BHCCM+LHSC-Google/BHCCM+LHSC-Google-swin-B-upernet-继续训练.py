...
load_from = '/opt/workspace/AI-Tianlong/openmmlab/mmsegmentation/work_dirs/BHCCM+LHSC-Google-swin-B-upernet-消融6/iter_80000.pth'
...
train_cfg.update(type=IterBasedTrainLoop, max_iters=80000, val_interval=4000) # 4000
