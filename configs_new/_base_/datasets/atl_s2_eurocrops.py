...
from mmseg.datasets.atl_s2_eurocrops import ATLS2EuroCrops
...
# dataset settings
dataset_type = ATLS2EuroCrops
data_root = 'data/dz/dataset/'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(
            img_path=
            '/opt/AI-Tianlong/Datasets/ATL-ATLNongYe/Crop-10m/Big-Image/images-xian-多边形矢量裁切',
            seg_map_path=
            '/opt/AI-Tianlong/Datasets/ATL-ATLNongYe/Crop-10m/Big-Image/labels-xian-new-矩形矢量裁切'
        ),
        ann_file = '/opt/AI-Tianlong/Datasets/ATL-ATLNongYe/Crop-10m/Big-Image/test_list.txt',
