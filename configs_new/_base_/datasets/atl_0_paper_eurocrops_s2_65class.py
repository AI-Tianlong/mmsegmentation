...
from mmseg.datasets.atl_0_paper_eurocrops_s2_65class import \
    ATL_S2_EuroCrops_Dataset_65class
...
# dataset settings
dataset_type = ATL_S2_EuroCrops_Dataset_65class
data_root = 'data/0-atl-paper-s2/2-EcroCrops-S2-NDVI-max_512_crop'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=None,
        data_prefix=dict(
            img_path='/opt/AI-Tianlong/Datasets/ATL-ATLNongYe/0-河南/商丘/'),
