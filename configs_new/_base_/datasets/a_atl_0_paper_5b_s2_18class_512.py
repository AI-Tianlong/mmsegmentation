...
data_root = 'data/1-paper-segmentation/2-多领域地物覆盖基础/0-Google-GF2-S2-地理配准-dataset-base512'
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        data_prefix=dict(
            img_path='img_dir/train/S2_5B_18_base512', seg_map_path='ann_dir/train/S2_5B_18_base512'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        data_prefix=dict(img_path='img_dir/val/S2_5B_18_base512', seg_map_path='ann_dir/val/S2_5B_18_base512'),
