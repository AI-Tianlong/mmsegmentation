...
with read_base():
    from .._base_.datasets.Harbin_25classes import *
...
load_from = '/opt/AI-Tianlong/openmmlab/mmsegmentation/work_dirs/GID_3_channels_beit_adapter_mask2former_4xb2_80k_load_pianlede/iter_8000.pth'
