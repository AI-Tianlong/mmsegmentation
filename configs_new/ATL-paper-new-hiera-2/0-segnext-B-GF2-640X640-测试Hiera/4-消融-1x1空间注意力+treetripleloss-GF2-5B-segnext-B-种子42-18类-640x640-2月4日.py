...
from mmseg.models.decode_heads.atl_hiera_37_ham_head_multi_convseg_attention import ATL_Hiera_LightHamHead_Multi_convseg_attentation_xiaorong4
# Loss
...
L1_num_classes = 4    # L1 num classes
L2_num_classes = 9    # L2 num classes
L3_num_classes = 18   # L3 num classes
...
model = dict(
    ...
    decode_head=dict(
        # type=ATL_Hiera_LightHamHead_Multi_convseg_baseline 不加注意力,
        ...
        # 经过修改的具有层级结构的
        type=ATL_Hiera_LightHamHead_Multi_convseg_attentation_xiaorong4,
        num_classes_level_list=[L1_num_classes,
                                L2_num_classes,
                                L3_num_classes],
        loss_decode=dict(
            type=ATL_Hiera_Loss_convseg, 
            num_classes=[L1_num_classes,
                         L2_num_classes,
                         L3_num_classes], 
            loss_weight=1.0),
