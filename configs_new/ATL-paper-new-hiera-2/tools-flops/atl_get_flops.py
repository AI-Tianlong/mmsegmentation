...
from build_utils import read_config
...
if __name__ == "__main__":
    config_list = [
        "/data/AI-Tianlong/openmmlab/mmsegmentation/configs_new/ATL-paper-new-hiera-2/1-piip-224-18类/PIIP-1-GF2-baseline-vit-deit-l-upernet-640-消融PIIP效果.py",
