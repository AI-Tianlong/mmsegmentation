...
pretrained = '/data/AI-Tianlong/openmmlab/mmsegmentation/checkpoints/2-对比实验的权重/piip/deit/3chan/deit_3chan_small_224_21k.pth'
...
model = dict(
    ...
    backbone=dict(
        ...
        depth=12,        # 12 12 24
        embed_dim=384,  # 384 768 1024 
        num_heads=16,    # 6 12 16
        mlp_ratio=4,
        qkv_bias=True,
        drop_path_rate=0.05, # 0.05  0.15  0.4
        init_scale=1.,
        with_fpn=True,
