...
load_from = '/opt/AI-Tianlong/checkpoints/atl_s2_农作物分类可用的权重/24类地物-BEIT-Adapter-24类地物覆盖-GID150张s2训练/5-s2-5billion-24类地物-用4的接着训-黑龙江省tain和val都训-iter80k-mIoU81.84.pth'
# load_from = None
